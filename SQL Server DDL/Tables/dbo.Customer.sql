...
ALTER TABLE [dbo].[Customer]
	ADD
	CONSTRAINT [CK__Customer__Gender__00551192]
	CHECK
	([Gender]='F' OR [Gender]='M')
GO
ALTER TABLE [dbo].[Customer]
CHECK CONSTRAINT [CK__Customer__Gender__00551192]
GO
ALTER TABLE [dbo].[Customer]
	ADD
	CONSTRAINT [CK__Customer__Custom__014935CB]
	CHECK
	([CustomerId]>(0))
GO
ALTER TABLE [dbo].[Customer]
CHECK CONSTRAINT [CK__Customer__Custom__014935CB]
GO

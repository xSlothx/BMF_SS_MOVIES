...
ALTER TABLE [dbo].[Employee]
	ADD
	CONSTRAINT [CK__Employee__Employ__060DEAE8]
	CHECK
	([EmployeeId]>(0))
GO
ALTER TABLE [dbo].[Employee]
CHECK CONSTRAINT [CK__Employee__Employ__060DEAE8]
GO
ALTER TABLE [dbo].[Employee]
	ADD
	CONSTRAINT [CK__Employee__Gender__07020F21]
	CHECK
	([Gender]='F' OR [Gender]='M')
GO
ALTER TABLE [dbo].[Employee]
CHECK CONSTRAINT [CK__Employee__Gender__07020F21]
GO
